 ...
 */
export function buildOrderQueryFilters(
	...
	const createdAfter = executeFunctions.getNodeParameter('createdAfter', itemIndex, '') as string;
	const createdBefore = executeFunctions.getNodeParameter('createdBefore', itemIndex, '') as string;
	...
	const orderFilters = executeFunctions.getNodeParameter('orderFilters', itemIndex, {}) as any;
